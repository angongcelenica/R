...
This is another example of using built in packages to simplify the data analysis process and in this case I demonstrate how I used 'ggplot2' to create my data visualistaions. It is important to first import the ggplot library in order to activate the packages so the fucntions can work.
